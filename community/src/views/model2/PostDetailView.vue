      ...
      <template v-else>
        ...
        <div class="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 mb-6">
          ...
          <div class="flex items-center gap-3 mt-5">
            ...
            <PostAdminActions :post-id="post.id" @changed="loadPost" @deleted="router.push('/module2/forum')" />
          </div>
        ...
        <div class="bg-slate-900/60 border border-slate-800 rounded-2xl p-4">
          <textarea
            ...
            rows="3"
            placeholder="写下你的评论..."
            class="w-full bg-slate-800/60 border border-slate-700 rounded-xl p-3 focus:outline-none focus:border-red-500 resize-none"
          ></textarea>
      ...
      >
        <div class="bg-slate-900 border border-slate-700 rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <input
            ...
            class="w-full mb-3 px-4 py-2 rounded-xl bg-slate-800 border border-slate-700 focus:outline-none focus:border-red-500"
            placeholder="标题"
          />
          ...
          <textarea
            ...
            rows="8"
            class="w-full mb-3 px-4 py-2 rounded-xl bg-slate-800 border border-slate-700 focus:outline-none focus:border-red-500 resize-none"
          ></textarea>
          <div class="flex justify-end gap-2">
            <button @click="isEditing = false" class="px-4 py-2 rounded-full bg-slate-800 text-slate-300">取消</button>
            <button
              @click="submitEdit"
              class="px-4 py-2 rounded-full bg-red-600 hover:bg-red-500 text-white"
            >
              保存
            </button>
          </div>
