    ...
    <div class="max-w-2xl mx-auto px-4 py-8">
      ...
      <div class="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 space-y-4">
        <div>
          ...
          <select v-model="boardId" class="w-full px-4 py-2 rounded-xl bg-slate-800 border border-slate-700 focus:outline-none focus:border-indigo-500">
        ...
        <div>
          ...
          <input
            ...
            class="w-full px-4 py-2 rounded-xl bg-slate-800 border border-slate-700 focus:outline-none focus:border-indigo-500"
          />
        </div>
        <div>
          ...
          <textarea
            ...
            class="w-full px-4 py-2 rounded-xl bg-slate-800 border border-slate-700 focus:outline-none focus:border-indigo-500 resize-none"
          ></textarea>
        ...
        <div class="flex justify-end gap-2">
          <button @click="router.push('/module3/forum')" class="px-4 py-2 rounded-full bg-slate-800 text-slate-300">取消</button>
          <button
            @click="submitPost"
            :disabled="submitting"
            class="px-4 py-2 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium hover:shadow-lg hover:shadow-indigo-500/30 transition disabled:opacity-50"
          >
            {{ submitting ? '发布中...' : '发布' }}
          </button>
        </div>
